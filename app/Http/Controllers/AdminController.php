...
class AdminController extends Controller
{
    ...
    public function sendPasswordResetLink(Request $request){
        $request->validate([
            ...
            'email.exists' => 'The :attribute does not exist on system'
        ]);
        ...
        //Check if their is an existing reset token
    ...
    public function resetPasswordHandler(Request $request){
        ...
        //Send email to noyify admin
        $data = array(
            'admin' => $admin,
            'new_passwword' => $request->new_passwword,
        );
    ...
    public function changeFavicon(Request $request){
        ...
        if ($upload) {
            ...
            return response()->json(['status'=>1, 'msg'=>'Done!, site favicon as been updated successfully']);
        } else {
