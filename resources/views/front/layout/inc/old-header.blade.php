                        ...
                        <ul class="ht-menu">
                            ...
                            <li>
                                ...
                                <div class="language ht-language">
                                    <ul class="ht-setting-list">
                                        <li class="active"><a href="#"><img src="/front/images/menu/flag-icon/1.jpg" alt="">English</a></li>
                                        <li><a href="#"><img src="/front/images/menu/flag-icon/2.jpg" alt="">Français</a></li>
                                    </ul>
                                </div>
                            </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="logo pb-sm-30 pb-xs-30">
                        <a href="index.html">
                            <img src="/front/images/menu/logo/1.jpg" alt="">
                        </a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                                    ...
                                    @foreach (get_categories() as $category)
                                        <li class="right-menu">
                                            <a href="javascript:void(0)" class="d-flex">
                                                <img src="/images/categories/{{ $category->category_image}}" style="width: 2rem; height:2rem;" alt="">
                                                <h6 class="text-danger">{{ $category->category_name }}</h6>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="col-lg-8 hb-menu hb-menu-2">
                        <nav>
                            <ul>
